...
- Imagine a resource limited edge environment where applications are deployed using container technology (maybe an environment such as [kubedge](https://kubeedge.io/en/)).
